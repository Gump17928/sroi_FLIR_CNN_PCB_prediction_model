...
The sroi_FLIR_CNN_PCB_prediction_model is an attempt at learning about, and reverse engineering the .sroi files that exist for FLIR, and to allow for a better understanding of the implication using an ML model to predict embedded thermal temperatures of PCBs.
